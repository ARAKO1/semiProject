...
function idcheck(){//과제
	...
	var id = request.getElementById("id").value;
	alert('아이디:' +id);
	if(id==''){
		alert('아이디를 입력하세요.');
	...
	window.open("idCheck.jsp?id="+id,"_blank","toolbar=yes,scrollbars=yes, resizable=yes, top=100, left=500,width=500,height=400");
}
</script>
<title>회원가입</title>
</head>
...
<form name="newMember" class="form-horizontal" 
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	    	...
	    	<select name="mail2">
	    	 ...
	    	 <input type="button" onclick="mail_confirm()" value="이메일 인증">
	    </div>
	</div>
	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	    	...
	    	<input name="phone1" maxlength="3">-
	    	<input name="phone2" maxlength="4">-
	    	<input name="phone3" maxlength="4">
	    </div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
	    <label class="col-sm-2">성별</label>
	    <div class="col-sm-10">
	    	<input name="새싹" type="radio"  checked="checked" disabled>
	    	<input name="Green" type="radio" >
	    	<input name="Gold" type="radio" >
	    	<input name="VIP" type="radio" >
	    	<input name="VVIP" type="radio" >
	    </div>
	</div>
