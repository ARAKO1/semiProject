...
<script>
	$(document).ready(function(){
		$("img").on({
			...
			click: function(){$(this).attr("src","./resources/images/checked.jpg");},
...
#all{font-size: 18px;}
#nonselected_option{font-weight: bold;font-size: 15px;}
#selected_option{font-weight: bold;font-size: 15px;}
p{text-align: left;}
p span{font-size:12px; color:green; /* font-weight: bold; */}
#select_option span{color: silver;font-weight:10px ;}
...
<!-- 		 <strong class="glyphicon glyphicon-ok-circle" id="icon"></strong>  -->
		<p style="font-weight:bolder; text-align: left; width: 500px;" id="all"><img src="./resources/images/check.jpg">이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선
																															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;택),프로모션 안내 메일 수신(선택)에 모두 동의합니다.</p>
<hr style="border: solid 0.5pt silver;">	
				<p  id="nonselected_option"><img src="./resources/images/check.jpg">TT마켓 약관동의<span>(필수)</span></p>
					<textarea>
여러분을 환영합니다.
...
<hr>			
			<fieldset>
				<p id="nonselected_option"><img src="./resources/images/check.jpg">개인 정보 수집 및 이용에 대한 안내<span>(필수)</span></p>
					<textarea>
...
<hr>			
			<fieldset>
				<p id="nonselected_option"><img src="./resources/images/check.jpg">개인정보 수집 및 이용에 대한 안내<span>(필수)</span></p>
					<textarea>
...
<hr>
	<p id="select_option" style="font-weight:bolder; text-align: left; width: 500px; "><img src="./resources/images/check.jpg">이벤트 등 프로모션 알림 메일 수신<span>(선택)</span></p>
		
		</form>
<br>
<div class="container" style="width: 500px;">
	 <button type="button" class="btn btn-success btn-lg" id="btn"  onclick= 'location.href="addMember.jsp"'>동의합니다.</button>
	 <button type="button" class="btn btn btn-lg" id="btn" onclick= 'location.href="welcome.jsp"'>취소합니다.</button>
</div>
<br><br><br><br><br>
	</div>
</div>
